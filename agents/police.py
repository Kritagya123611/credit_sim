...
class PoliceOfficer(BaseAgent):
    def __init__(self, economic_class='Lower_Middle', financial_personality='Saver'):
        ...
        profile_attributes = {
            ...
            "employment_status": "Salaried", "employment_verification": "GOVT_Verified",
            "income_type": "Uniformed_Services_Salary", "avg_monthly_income_range": modified_income_range,
            "income_pattern": "Fixed_Date", "savings_retention_rate": "Medium",
            "has_investment_activity": True, "investment_types": ["LIC", "FD"],
            ...
            "insurance_types": ["LIC", "Government_Schemes"], "utility_payment_status": "ALWAYS_ON_TIME",
            "mobile_plan_type": "Postpaid", "device_consistency_score": round(random.uniform(0.92, 0.98), 2),
            "ip_consistency_score": round(random.uniform(0.75, 0.85), 2), "sim_churn_rate": "Low",
            "primary_digital_channels": ["Mobile_Banking", "UPI"], "login_pattern": "Shift_Work_Night_Activity",
            "ecommerce_activity_level": "Low", "ecommerce_avg_ticket_size": "Medium",
        }
            ...
            if txn: 
                ...
                if self.family_member_recipient:
                    ...
                    context.get('p2p_transfers', []).append({
                        'sender': self, 'recipient': self.family_member_recipient, 
                        'amount': remittance_amount, 'desc': 'Family Remittance',
                        'channel': 'UPI'
                    })
